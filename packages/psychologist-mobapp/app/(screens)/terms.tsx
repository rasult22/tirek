...
export default function TermsScreen() {
  ...
  return (
    <>
      <Stack.Screen options={{ title: t.profile.termsAndConditions }} />
      <ScrollView
      ...
      >
        ...
        <H3 style={styles.h1}>Terms & Conditions</H3>

        <Body style={styles.p}>
          These terms and conditions apply to the tirek - панель психолога app
        ...
        <Body style={styles.p}>
          ...
          and access to the Application. The Service Provider strongly advise
        ...
        <H3 style={styles.h2}>Changes to These Terms and Conditions</H3>
        <Body style={styles.p}>
