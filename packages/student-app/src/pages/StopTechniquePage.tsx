    ...
    <div className="flex min-h-screen flex-col bg-bg">
      ...
      <div className="flex flex-1 flex-col items-center px-5 pt-6">
        ...
        <textarea
          ...
          rows={4}
          className="mt-5 w-full max-w-sm resize-none rounded-2xl border-0 bg-white p-4 text-sm text-text-main shadow-sm placeholder:text-text-light/50 focus:outline-none focus:ring-2 focus:ring-primary/30"
        />
      </div>
